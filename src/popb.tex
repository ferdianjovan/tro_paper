...
Here, we extended the original POPP model to take into account uncertainty in the true and false positive rates due to limited training data.
% 
...
\textbf{NOTE: I've cut the definition of the beta-binomial as it's a thing that can easily be looked up. A more serious question is how we should cite the different distributions and derivations we're relying on}
...
% 
$\eta_{\tau}$ and $\eta_{\xi}$ are the number of false negative and true  negative detections in the groud truth data respectively. 
% 
