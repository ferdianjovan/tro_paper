...
\begin{figure}[t!]
	...
	\caption{The improvement ratio of activity observations during each phase of the trial. A ratio of 1.0 means that the exploration model gives no improvement over time in finding more people.}
	\label{fig:exploration_improvement_ratio}
\end{figure}
